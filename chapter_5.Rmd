...
Step1: 选择eatdrink为1的被试<br>
<br>
Step2: 选择我们需要的变量<br>
<br>
Step3: 对反向计分题目重新编码<br>
<br>
Step4: 将出生年份编码为出生年代<br>
<br>
Step5: 按年代计算ALEX的平均值<br>
<br>
...
Step1: 选择我们需要的变量<br>
<br>
Step2: 删除缺失值，选择符合标准的被试(右利手，有效反应试次，反应时[200ms,1500ms])<br>
<br>
Step3: 分实验条件计算平均反应时和正确率，以及效率 = 平均反应时/平均正确率<br>
<br>
Step4: 将Shape变量拆分为Valence和Identity，选取Match-Moral组<br>
<br>
Step5: 将长数据转化为宽数据，得到Self和Other情况下的efficiency<br>
<br>
Step6: 计算实验条件为Match-Moral时efficiency的SPE<br>
<br>
