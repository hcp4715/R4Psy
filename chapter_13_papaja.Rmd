...
## Reaction times
A two-way repeated-measure ANOVA revealed a significant interaction between Identity and Valence. *F*(`r ANOVA_rt$anova_table$"num Df"[3]`, `r ANOVA_rt$anova_table$"den Df"[3]`) = `r ANOVA_rt$anova_table$F[3]`, *p* = 0.0005. We conducted follow-up simple main effect analyses. When the shapes were self-referential, *d'* was significantly larger for moral condition (637.47 $\pm$ 63.57) than for immoral condition (720.40 $\pm$ 70.04), *t*(41) = 4.29, *p* < 0.001. However, this was no clear evidence that moral condition (2.11 $\pm$ 0.116) and immoral condition (2.27 $\pm$ 0.107) were not significantly different when the shapes are other-referential (see figure \@ref(fig:plot1)).
