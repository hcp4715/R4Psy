...
files <- list.files(  #<<
  ## <- & =
  here::here("slides", "slides", "data", "match"), 
...
bruceR::export(
  df3, 
  file = here::here("slides", "slides", "data", "match","match_raw.csv"))
...
pg_raw <- bruceR::import(here::here(
  "slides", "data", "penguin","penguin_rawdata.csv"))

mt_raw <- bruceR::import(here::here(
  "slides", "data", "match","match_raw.csv")) 
