...
We used R (Version 4.5.2; R Core Team, 2023) and the R-packages \emph{dplyr} (Version 1.2.0; Wickham, François, Henry, Müller, \& Vaughan, 2023), \emph{forcats} (Version 1.0.1; Wickham, 2023), \emph{ggplot2} (Version 4.0.2; Wickham, 2016), \emph{here} (Version 1.0.2; Müller, 2020), \emph{lubridate} (Version 1.9.5; Grolemund \& Wickham, 2011), \emph{papaja} (Version 0.1.4; Aust \& Barth, 2023), \emph{purrr} (Version 1.2.1; Wickham \& Henry, 2023), \emph{readr} (Version 2.1.6; Wickham, Hester, \& Bryan, 2023), \emph{report} (Version 0.6.3; Makowski et al., 2023), \emph{stringr} (Version 1.6.0; Wickham, 2022), \emph{tibble} (Version 3.3.1; Müller \& Wickham, 2023), \emph{tidyr} (Version 1.3.2; Wickham, Vaughan, \& Girlich, 2023), \emph{tidyverse} (Version 2.0.0; Wickham et al., 2019), and \emph{tinylabels} (Version 0.2.5; Barth, 2023) for all our analyses.

\section{Results}\label{results}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Demo_files/figure-latex/dprime-1.pdf}}
...
\bibitem[\citeproctext]{ref-R-report}
