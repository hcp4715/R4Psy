...
# 用管道操作符合并以上代码
df7_1 <- bruceR::import(here::here("slides", "data", "match","match_raw.csv")) %>%
...
```{r 8.1}
# 用管道操作符合并以上代码
df8_1 <- bruceR::import(here::here("slides", "data", "match","match_raw.csv")) %>%
  dplyr::select(Sub, Age, Sex, Hand, #人口统计学
                Block, Bin, Trial,   # 试次
                Shape, Label, Match, # 刺激
                Resp, ACC, RT) %>%  # 反应结果
...
```{r 8.2 pic_box}
df8_2 <- bruceR::import(here::here("slides", "data", "match", "match_raw.csv")) %>%
