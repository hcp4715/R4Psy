...
# 6.2 用OpenCode把方案设计变成coding（1/3）
...
# 6.2 用OpenCode把方案设计变成coding（2/3）
...
# 6.2 用OpenCode把方案设计变成coding（3/3）
