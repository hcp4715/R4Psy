...
<br>
<span style="font-size: 45px;">12.4 AI辅助科研绘图</span></center> <br>
<br>
...
## 必须图层
```{r echo=FALSE, out.width='70%', fig.align='center'}
knitr::include_graphics('./picture/chp12/required.png')
```
...
---
class: center, middle
<span style="font-size: 60px;">12.4 AI 辅助科研绘图</span> <br>
...
GitHub: [https://github.com/dazhiyang/scientific-plotting-skill](https://github.com/dazhiyang/scientific-plotting-skill)

<br>

- 面向 coding agent 的科研绘图 skill；
- 目标是帮助生成 publication-style figures；
- 与本章 ggplot2、图形细节调整、论文图导出等内容直接相关；
- 可作为科研绘图任务的 prompt / coding-agent 规范参考。
...
knitr::include_graphics('picture/chp12/scientific_plots.png')
```
...
在使用 AI 辅助科研绘图时，需要清楚说明任务背景、目标、风格和输出格式。 在用于组织绘图 prompt时，需要建立 结构化的思考模式。
- 参考：[https://mp.weixin.qq.com/s/mrRpH-pRqHNZluxpK9NhxQ](https://mp.weixin.qq.com/s/mrRpH-pRqHNZluxpK9NhxQ)

```{r echo = F,out.width="50%"}
knitr::include_graphics('picture/chp12/costar.png')
```
...
- CoSTAR prompt 写作参考: https://mp.weixin.qq.com/s/mrRpH-pRqHNZluxpK9NhxQ
