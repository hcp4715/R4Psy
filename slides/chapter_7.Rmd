...
<span style="font-size: 35px;">回顾：数据分析的问题解决思路</span></center> <br>
...
- 7.2 基于LLM和OpenCode的实操演练
  ...
  - 7.2.3 分析笔记文件 analysis_notes.md
  - 7.2.4 实操演练
]
...
files <- list.files(here::here("slides", "data", "match"),
...
.font-size-14[
将 Sub 从 character 转为 numeric，避免 bind_rows 时类型不匹配
]
...
<span style="font-size: 28px;">7.1.1 操作步骤 | Step0: 实验数据处理概述</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step1: 读取单个文件</span></center><br>
.font-size-14[
- 读取单个被试的反应时数据
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step1: 批量读取数据 - for loop</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | for loop 的基本语法</span></center><br>
.font-size-14[
**for loop 语法：**
```
for (变量 in 序列) {
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step1: 使用 for loop 批量读取文件</span></center><br>
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step1: 使用 lapply 批量读取</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step2: 排除无效试次</span></center><br>
.font-size-14[
实验数据清洗：排除无效试次
]
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step3: 按条件计算均值</span></center><br>
.font-size-14[
按被试和实验条件计算平均反应时和正确率
]
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step4: 拆分变量 - extract</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step5: 长宽数据转换 - pivot_wider</span></center><br>
.font-size-14[
pivot_wider: 长数据 -> 宽数据
]
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step5: pivot_wider 函数说明</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 28px;">7.1.1 操作步骤 | Step6: 计算派生指标 - SPE</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 30px;">7.1.1 操作步骤 | 完整流程1 </span></center><br>
**读取并清洗原始数据（1/2）**
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 30px;">7.1.1 操作步骤 | 完整流程2 </span></center><br>
**读取并清洗原始数据（2/2）**
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 30px;">7.1.1 操作步骤 | 完整流程3 </span></center><br>
**分组计算均值，并拆分 Shape**
...
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据</h1>
<span style="font-size: 30px;">7.1.1 操作步骤 | 完整流程4 </span></center><br>
**长转宽并计算 SPE**
...
---
# <h1 lang="en">7.1 基于Tidyverse处理反应时数据——实例 </h1>
...
数据：我已经加载了 penguin 数据集，数据框叫 df，
包含 Site、age、weight_kg、height_cm、sex。
```
]
...
# 7.2.3 分析笔记文件：analysis_notes.md（1/4）
...
# 7.2.3 分析笔记文件：analysis_notes.md（2/4）
...
This file describes my RT analysis logic.
...
# 7.2.3 分析笔记文件：analysis_notes.md（3/4）

.font-size-14[
**analysis_notes.md 示例内容：**
...
# 7.2.3 分析笔记文件：analysis_notes.md（4/4）
