...
---
# <h1 lang="en">.font-size-14[
数据来自 Hu et al., 2020 的实验
]<br>
<br>
...
---
# <h1 lang="en">7.1.1 研究问题 & 数据情况回顾 </h1>
...
<span style="font-size: 30px;">本课数据预处理目标 </span></center><br>
- 计算Match-Moral条件下时RT的自我优势效应(SPE)。<br>
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step1: 读取单个文件</span></center><br>
.font-size-14[
- 读取单个被试的反应时数据
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;">Step1: 批量读取数据 - for loop</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step1: for loop 的基本语法</span></center><br>
.font-size-14[
**for loop 语法：**
```
for (变量 in 序列) {
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step1: 使用 for loop 批量读取文件</span></center><br>
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step1: 使用 lapply 批量读取</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step2: 选择变量并排除无效试次</span></center><br>
.font-size-14[
实验数据清洗：排除无效试次
]
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step3: 处理缺失值 </span></center><br>
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step4: 分实验条件计算变量</span></center><br>
.font-size-14[
按被试和实验条件计算平均反应时和正确率
]
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step5: 拆分变量 - extract</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step6: 长宽数据转换 - pivot_wider</span></center><br>
.font-size-14[
pivot_wider: 长数据 -> 宽数据
]
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step6: pivot_wider 函数说明</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 28px;"> Step7: 计算派生指标 - SPE</span></center><br>
.font-size-14[
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 30px;">  完整流程1 </span></center><br>
**读取并清洗原始数据（1/2）**
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 30px;"> 完整流程2 </span></center><br>
**读取并清洗原始数据（2/2）**
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 30px;"> 完整流程3 </span></center><br>
**分组计算均值，并拆分 Shape**
...
# <h1 lang="en">7.1.2 操作步骤</h1>
<span style="font-size: 30px;"> 完整流程4 </span></center><br>
**长转宽并计算 SPE**
