...
class: center, middle
<span style="font-size: 60px;">第四章</span> <br>
...
--
- # <font size = 5.5> 
问卷数据：Human Penguin Project </font> 

- # <font size = 5.5> 
实验数据：Perceptual matching </font> 
...
路径:  如果我们要找到 R4Psy 中data文件夹下的 penguin 的数据集 penguin_rawdata.csv，需要先打开 R4Psy 文件夹：
</font>
...
<br>
<font size=5.5 class=center color=red>
"/Users/czarray/Documents/github/R4Psy/data/penguin/penguin_rawdata.csv"
</font>
...
-   相对路径相当于设置了某个文件夹作为搜寻的“起点”(即R4Psy)；
...
.footnote[注：在Psychopy(Python)及大多数编程语言中，路径都支持斜杠（/）]
...
penguin_data = import('data/penguin/penguin_rawdata.csv')
...
-   <font size=5>由于已经加载bruceR，`bruceR::import()`简写为 `import()`
...
<font size=5.5>3、需要上交如下内容：<br><br></font>  

-   <font size=5.5>代码（RMD格式，最好使用papaja进行准备）
</font>  <br><br>

-   <font size=5.5>文档（PDF或者Word，采用APA格式撰写,推荐由Papaja生成）  </font><br><br>

-   <font size=5.5>报告（PPT或者HTML在课堂上展示）  
</font><br><br>
...
-   <font size=5.5>与文献相一致的统计检验或模型验证</font>  <br><br>  
