...
<span style="font-size: 50px;">实验数据预处理与函数</span> <br>
<br>
<br>
...
<br>
<span style="font-size: 40px;">7.1 基于Tidyverse处理反应时数据</span></center> <br>
...
- 通过这个练习，你将学习如何定义一个函数，接受多个参数，并在函数体内执行基本的算术运算
...
&emsp;1 定义一个函数用于计算$d′$ 
&emsp;2 计算不同Shape情况下(immoralself，moralself，immoralother，moralother)<br>基于信号检测论match与mismatch(match为信号，mismatch噪音)之间的d'<br>
