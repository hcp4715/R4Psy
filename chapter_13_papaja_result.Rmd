...
print(ANOVA_rt)
## simple main effect analysis:
simple_effect_rt <- emmeans::emmeans(ANOVA_rt, "Valence", by = "Identity")
print(simple_effect_rt)
simple_effect_rt_test <- pairs(simple_effect_rt)  
print(simple_effect_rt_test)
```

## Reaction times

A two-way repeated-measure ANOVA revealed a significant interaction between Identity and Valence. *F*(`r ANOVA_rt$anova_table$"num Df"[3]`, `r ANOVA_rt$anova_table$"den Df"[3]`) = `r ANOVA_rt$anova_table$F[3]`, *p* < 0.001.We conducted follow-up simple main effect analyses. When the shapes were self-referential, *d'* was significantly larger for moral condition (685 $\pm$ 8.92) than for immoral condition (733 $\pm$ 10.20), *t*(41) = -7.04, *p* < 0.001. However, this was no clear evidence that moral condition (710 $\pm$ 10.70) and immoral condition (719 $\pm$ 9.53) were not significantly different when the shapes are other-referential. 
