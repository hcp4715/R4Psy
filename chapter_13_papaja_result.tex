...
\begin{figure}
\centering
\includegraphics{chapter_13_papaja_result_files/figure-latex/plot1-1.pdf}
...
## 1         Identity 1, 41 1181.37      1.06 .002    .309
## 2          Valence 1, 41  903.07 39.43 *** .051   <.001
## 3 Identity:Valence 1, 41 1156.92 13.97 *** .024   <.001
## ---
...
##  Good       685  8.92 41      667      703
##  Bad        733 10.20 41      713      754
## 
## Identity = Other:
##  Valence emmean    SE df lower.CL upper.CL
##  Good       710 10.70 41      688      731
##  Bad        719  9.53 41      700      738
## 
...
##  Good - Bad    -48.7 6.92 41  -7.037  <.0001
## 
## Identity = Other:
##  contrast   estimate   SE df t.ratio p.value
##  Good - Bad     -9.5 7.08 41  -1.342  0.1869
\end{verbatim}

\subsection{Reaction times}\label{reaction-times}

A two-way repeated-measure ANOVA revealed a significant interaction between Identity and Valence. \emph{F}(1, 41) = 13.97, \emph{p} \textless{} 0.001.We conducted follow-up simple main effect analyses. When the shapes were self-referential, \emph{d'} was significantly larger for moral condition (685 \(\pm\) 8.92) than for immoral condition (733 \(\pm\) 10.20), \emph{t}(41) = -7.04, \emph{p} \textless{} 0.001. However, this was no clear evidence that moral condition (710 \(\pm\) 10.70) and immoral condition (719 \(\pm\) 9.53) were not significantly different when the shapes are other-referential.
