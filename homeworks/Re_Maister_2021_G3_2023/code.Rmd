...
#1 准备工作
#1.1 读取数据
ALL <- read.csv('./data_analysis/reproducible/RDM.csv', header = TRUE)
real_vs_real <- read.csv('./data_analysis/reproducible/real_vs_real.csv', header = FALSE)
portrait_vs_portrait <- read.csv('./data_analysis/reproducible/portrait_vs_portrait.csv', header = FALSE)
gender_matrix <- read.csv('./data_analysis/reproducible/gender_matrix.csv', header = FALSE)
identity_matrix <- read.csv('./data_analysis/reproducible/identity_matrix.csv', header = FALSE)
...
human_class_acc <- read.csv('./data_analysis/reproducible/human_control_exp.csv', header = FALSE)#读取40个评分者对77名被试自画像的分类的平均正确率
...
#3.1前期准备工作
ALL_TRIALS_BFI <- read.csv('./data_analysis/reproducible/EXP1_BFI.csv', header=TRUE) 
...
final_LONG_TRAIT <- read.csv('./data_analysis/reproducible/EXP1_TRAIT.csv', header=TRUE) 
...
#4.1构建多层线性回归模型
#读取数据
data <- read.csv('./data_analysis/reproducible/acc_indivDiff.csv', header=TRUE) 
