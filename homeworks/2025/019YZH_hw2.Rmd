...
pacman::p_load(
  here, tidyverse, bruceR, ggplot2, patchwork)
...
# dplyr
library(dplyr)
Q2<- filter(Q1,Site=='Oxford')%>%
  slice(13:32)
# Base R
A1 <- Q1[Q1$Site=='Oxford',]
A2 <- A1[13:32,]
...
# 查看数据类型
str(Q3) #'health'和'phone1-8'均为整数型，'phone9'是字符型
#转化，完成后可重新查看数据类型检查
