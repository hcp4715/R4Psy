...
simulateDistribution_withMetaNoise <- function(m1, m2, b, internalNoise, diffRight, diffLeft, reps, shift, metanoise, metaNpriorChoice, metaNpriorConf, metaNLikChoice, metaNpriorChoiceDouble)
{
  reps = reps
  mode_m = mode_m
