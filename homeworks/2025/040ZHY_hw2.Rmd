...
# 也可以用基础包，输入路径读取
Q1 <- read.csv("D:/Desktop/Rcode/R4psy/data/penguin/penguin_rawdata.csv")
#或
...
# Base R
selected_cols <- c("health", paste0("phone", 1:9))
Q3 <- Q2[, selected_cols]
# 查看数据类型
str(Q3)
#'data.frame':	20 obs. of  10 variables:
# $ health: int  4 3 2 3 3 4 4 3 5 4 ...
# $ phone1: int  1 1 2 2 3 1 1 1 1 2 ...
# $ phone2: int  4 3 3 4 2 4 3 4 3 2 ...
# $ phone3: int  1 1 1 1 2 1 2 1 1 2 ...
# $ phone4: int  4 3 3 2 4 4 3 4 2 4 ...
# $ phone5: int  1 1 1 2 2 2 1 2 1 2 ...
# $ phone6: int  1 1 1 1 4 1 1 1 1 3 ...
# $ phone7: int  2 3 2 2 3 2 1 1 1 3 ...
# $ phone8: int  1 2 2 2 4 4 1 1 1 2 ...
# $ phone9: chr  "3" "1" "3" "2" ...
#转化，完成后可重新查看数据类型检查
Q3 <- Q3 %>%
...
Q13 <- Q10 %>%
  filter(
    health %in% c("Good", "Very Good", "Excellent"),
    phone_total >= 36
  )
