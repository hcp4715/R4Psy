...
```{r homework 1}
Q1 <- read.csv("E:/R-4.4.3/test3/kejian/R4Psy/R4Psy/data/penguin/penguin_rawdata.csv")
```

2.根据下列图片中自己所在的位置（所在行代表应选取的站点；所在列代表在固定站点后、应选取的特定的行；如Tsinghua(1,20)，即表示学号尾号为302001的同学完成作业时，需要选出“Tsinghua”这站点数据的第1到第20行的数据（提示：在Tidyverse中可以调用slice函数来选定相应的列）。![pic1](picture/homework/pic1.png)
