...
func <- function(a = 1, b = 1) {return((a + b)^2)}
Q14 <- func(a = 3, b = 4)
Q14
```
...
func4 <- function(x) {if (x > 0) "Positive" else if (x < 0) "Negative" else "Zero"}
Q17 <- func4(-3)
```
...
func6 <- function(n) {result <- 1
  for (i in 1:n) {result <- result * i}return(result)}
Q21 <- func6(5)
```
---