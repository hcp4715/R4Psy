...
str(Q3) #查看Q3数据类型，phone9是chr
Q3$phone9 <- as.integer(Q3$phone9) #将phone9转为数字类型
str(Q3) #再次检查
```
...
```{r homework 9}
Q9 <- str_sub(as.character(Q5), 1, 1)
Q9
```
...
# 使用函数计算向量 c(1, 2, 3, 4, 5) 的均值和标准差，并将结果赋值为 Q15
