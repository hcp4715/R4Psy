...
# dplyr
Q3 <- Q2 %>%
  select(health, matches("^phone[1-9]$"))
View(Q3)
str(Q3)
...
# $ health: int  4 3 2 3 2 3 3 3 2 3 ...
# $ phone1: int  1 2 1 3 3 1 1 2 1 2 ...
# $ phone2: int  1 2 3 4 3 1 1 2 4 2 ...
# $ phone3: int  1 2 2 1 3 1 1 2 1 2 ...
# $ phone4: int  1 1 4 4 3 1 1 2 2 2 ...
# $ phone5: int  1 2 1 2 3 1 1 2 1 2 ...
# $ phone6: int  1 1 2 2 3 1 1 2 1 2 ...
# $ phone7: int  1 2 2 2 3 1 1 2 2 2 ...
# $ phone8: int  1 2 4 3 3 1 1 2 1 2 ...
# $ phone9: chr  "1" "2" "4" "2" ...
#转化，完成后可重新查看数据类型检查
Q3 <- Q3 %>%
  mutate(phone9 = as.numeric(phone9))
str(Q3$phone9) 
#num [1:20] 1 2 4 2 3 1 1 2 2 2 ...
```
...
Q4 <- Q3 %>%
  mutate(health = case_when(
    ...
    health == 2 ~ "Fair",
    health == 1 ~ "Poor",
    TRUE ~ NA_character_  # 处理可能的 NA 或其他无效值
  ))
...
Q5 <- Q5 %>%
  mutate(health = factor(
    health,
    levels = c("Poor", "Fair", "Good", "Very Good", "Excellent"),  # 指定顺序
    ordered = TRUE
  )) %>%
  arrange(health)
...
Q8
#长度分别为：4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 9 9 9
```

9.使用str_sub()函数，提取Q5中每个元素的第一个字母，并输出为Q9(tips:可以使用"?"查看函数功能)
```{r homework 9}
?str_su
Q9 <- str_sub(as.character(Q5$health), start = 1, end = 1)
Q9
# "P" "F" "F" "F" "F" "F" "F" "G" "G" "G" "G" "G" "G" "G" "G" "G" "G" "V" "V" "V"
```
...
Q11 <- Q10 %>%
  ...
  pull(Num)
Q11
#num:1  2  4  6  7  8 10 13 14 15 16 17 18
...
Q10 <- Q10 %>%
  ...
  relocate(phone_total, .after = last_col())  # 将总分列移到最后一列
head(Q10)
